...
void GenericApp_Init( byte task_id )
{
  ...
  GenericApp_DstAddr.addr.shortAddr = 0xFFFE;
  ...
  Hal_Oled_WriteString(HAL_OLED_XSTART,HAL_OLED_LINE_3,"GenericApp",SIZE1 );
...
static void rxCB(uint8 port,uint8 event)
{
  if ((event & (HAL_UART_RX_FULL | HAL_UART_RX_ABOUT_FULL | HAL_UART_RX_TIMEOUT)))
  {
    ...
    //
    SerialApp_TxLen = HalUARTRead(0, RxBuf, 80);
